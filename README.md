...
## 🚀 Recursos
- API baseada em gRPC
- Operações essenciais: **GET**, **SET**, **DELETE**, **TTL**, **FlushAll**
- Suporte a **TTL** com expiração automática
- Cliente oficial para **.NET** (NuGet)
- Dockerfile e imagem oficial
- Baixa latência e excelente throughput
- Implementação leve e fácil de entender
